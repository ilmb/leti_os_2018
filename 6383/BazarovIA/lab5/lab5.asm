...
;ïåðåâîä áàéòà èç AL â äâà ñèìâîëà HEX
...
;îáðàáîòêà õâîñòà êîìàíäíîé ñòðîêè
cmds_buf:       xor     BH, BH          
                xor     CH, CH
                mov     CL, ES:[80h]    
                cmp     CL, 00h         
...
;ïðîâåðêà óñòàíîâëåííîãî âåêòîðà ïðåðûâàíèÿ
